public class Main {
    public static void main(String[] args) {
        ...
        Wydarzenie koncert = new Wydarzenie("Koncert Symphony", 120.0, "2025-05-01", "Warszawa");
        Wydarzenie teatr = new Wydarzenie("Hamlet", 85.0, "2025-04-15", "Kraków");
        ...
        system.dokonajRezerwacji(klient2, teatr);
